...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FinAgent — Autonomous Financial Research" },
      { name: "description", content: "AI-powered financial research agent: stock analysis, sentiment, risk, and reports." },
      { property: "og:title", content: "FinAgent — Autonomous Financial Research" },
      { property: "og:description", content: "Plan, fetch, analyze, and report on stocks with an autonomous AI agent." },
